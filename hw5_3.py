...
# Hint: use f-string to format the output.
# For example, to dedicate two spaces for i and two spaces + right-align for j,
# you can use f'{i:2}*{j:>2}'.
# For example, to dedicate two spaces for i and two spaces + left-align for j,
# you can use f'{i:2}*{j:<2}'.
...
'''
# Hint: use two nested loops to generate the multiplication table.